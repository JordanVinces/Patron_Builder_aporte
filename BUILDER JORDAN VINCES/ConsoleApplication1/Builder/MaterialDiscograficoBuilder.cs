...
namespace ConsoleApplication1.Builder
{
    ...
    //ESTA POSEE LOS ATRIBUTOS DE LA CLASE QUE SE LE ESTA APLICANDO AL PATRON BUILDER
    public class MaterialDiscograficoBuilder : IMaterialDiscograficoBuilder
    {
        ...
        public MaterialDiscografico BuildMaterialDiscografico()
        {
            ...
            //RETORNO DE LOS NUEVOS OBJETOS
            // AQUI RETORNAN EL MISMO BUILDER PERO CON LOS ATRINUTOS MODIFICADOS 
